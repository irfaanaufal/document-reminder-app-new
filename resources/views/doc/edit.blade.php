                            ...
                            <div class="pt-6 border-t border-gray-200 dark:border-zinc-700">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="pic_external_telpon" name="pic_external_telpon" type="tel" class="mt-1 block w-full" :value="old('pic_external_telpon', $reminder->pic_external_telpon)" maxlength="15" oninput="this.value = this.value.replace(/[^0-9]/g, '')" />
                                    </div>
                                </div>
                            </div>
                        </div>
