                ...
                <div class="overflow-x-auto">
                    <table data-datatable class="min-w-[720px] w-full table-fixed divide-y divide-gray-200 dark:divide-zinc-800 text-sm">
                        <thead class="bg-gray-50 dark:bg-zinc-900">
                            <tr>
                                <th class="w-[8%] px-4 py-3 text-left text-[13px] font-bold tracking-wide text-gray-700 dark:text-zinc-200">No</th>
                                <th class="w-[22%] px-4 py-3 text-left text-[13px] font-bold tracking-wide text-gray-700 dark:text-zinc-200">Nama Jenis</th>
                                <th class="w-[22%] px-4 py-3 text-left text-[13px] font-bold tracking-wide text-gray-700 dark:text-zinc-200">Tipe Form</th>
                                <th class="w-[13%] px-4 py-3 text-left text-[13px] font-bold tracking-wide text-gray-700 dark:text-zinc-200">Status</th>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-zinc-800">
                            ...
                            @empty
                                <tr>
                                    <td colspan="{{ $canManageDocumentTypes ? 6 : 5 }}" class="px-4 py-6 text-center text-gray-500 dark:text-zinc-400">Belum ada jenis dokumen.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
